...
export default ({
  ...
  const onClickView = (_, row) => {
    ...
    redirectDetail('/psn/psnMgrCard', { personId: row.personId, record: row });
  };

  const onClickAdvQuery = () => {
  ...
  return (
    <div>
      <Button.Group>
        <Button type="primary" style={{ margin: '10px 0' }} onClick={onClickAdvQuery}>高级查询</Button>
