...
export default {
  ...
  state: {
    ...
    {
      dataIndex: 'householdRegisterType',
      key: 'householdRegisterType',
      title: '户口类型',
      isCheck: false,
      align: 'center',
      width: 200,
    ...
    {
      dataIndex: 'qualificationNameOther',
      key: 'qualificationNameOther',
      title: '其他名称',
      isCheck: false,
      align: 'center',
      width: 100,
    ...
    {
      dataIndex: 'professionComments',
      key: 'professionComments',
      title: '其他',
      isCheck: false,
      align: 'center',
      width: 100,
    ...
    {
      dataIndex: 'initialJobStartDate',
      key: 'initialJobStartDate',
      title: '参加工作日期',
      isCheck: false,
      align: 'center',
      width: 100,
